      ...
      <div className={`flex flex-col sm:flex-row gap-4 mb-6 ${showFilters ? '' : 'hidden sm:flex'}`}>
        ...
        <div className="flex gap-2 sm:ml-auto">
          <select
            ...
            className="px-3 py-2 bg-white border border-gray-200 rounded-lg text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#046cbb]"
          >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <div className="flex items-center gap-3 sm:w-44 justify-end">
                  <div className="text-right">
                    <div className="text-xl font-bold text-[#035a9e]">
                  ...
                  <a
                    ...
                    className="flex items-center gap-1 px-4 py-2 bg-[#046cbb] hover:bg-[#035a9e] text-white font-medium text-sm rounded-lg transition-colors whitespace-nowrap"
                  >
                    Book
        ...
        {sortedSchedules.length === 0 && (
          <div className="text-center py-12 text-gray-500">
            ...
            <button
              ...
              className="mt-2 text-[#035a9e] hover:underline text-sm"
            >
              Clear filters
            </button>
          </div>
